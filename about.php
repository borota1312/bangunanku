...
<body class="goto-here">
      ...
      <div class="row">
        <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
          <div class="heading-section-bold mb-4 mt-md-5">
            <div class="ml-md-0">
              <h2 class="mb-4">Bangunanku</h2>
            </div>
          </div>
          <div class="pb-md-5">
            <p>Website kami dirancang dengan baik untuk memberikan pengalaman berbelanja yang mudah, cepat, dan menyenangkan bagi para pelanggan kami. Dengan navigasi yang intuitif dan antarmuka yang ramah pengguna, Anda dapat dengan mudah menjelajahi berbagai kategori produk yang kami sediakan.</p>
            <p> Kami menawarkan beragam produk berkualitas tinggi, mulai dari bahan bangunan seperti batu bata, semen, kayu, dan besi, hingga peralatan dan perkakas seperti palu, gergaji, cat, serta peralatan listrik. Produk-produk kami dipilih dengan teliti dari merek-merek terkemuka di industri, sehingga Anda dapat memiliki kepercayaan penuh pada kualitas dan keandalan mereka.</p>
  ...
  <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/kitchenkitt.jpg);">
    <div class="container">
          ...
          <div class="row">
            <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
              <div class="block-18 text-center">
                <div class="text">
                  <strong class="number" data-number="140303">0</strong>
